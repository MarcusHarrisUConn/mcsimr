export_quarto_project <- function(spec,
  ...
  writeLines(c(
    ...
    "if (nrow(missingness_diagnostics)) utils::write.csv(missingness_diagnostics, 'results/missingness-diagnostics.csv', row.names = FALSE)",
    "if (nrow(truth_map)) utils::write.csv(truth_map, 'results/truth-map.csv', row.names = FALSE)",
    "utils::write.csv(reporting_checklist, 'results/reporting-checklist.csv', row.names = FALSE)",
    "utils::write.csv(readiness, 'results/readiness.csv', row.names = FALSE)",
    "utils::write.csv(readiness_decision, 'results/readiness-decision.csv', row.names = FALSE)",
