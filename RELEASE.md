...
- Review exported Quarto projects for `readiness.csv`, `readiness-decision.csv`, diagnostics, reporting checklist, reproducibility metadata, methods text, tables, and figures.
